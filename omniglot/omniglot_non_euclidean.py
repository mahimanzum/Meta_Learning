...
class CNNEncoder(nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = nn.Sequential(
                        mnn.rConv2d(1,64,kernel_size=3,padding=0, weight_manifold = mnn.Stiefel),
                        nn.BatchNorm2d(64, momentum=1, affine=True),
                        nn.ReLU(),
                        nn.MaxPool2d(2))
        self.layer2 = nn.Sequential(
                        mnn.rConv2d(64,64,kernel_size=3,padding=0, weight_manifold = mnn.Stiefel),
                        nn.BatchNorm2d(64, momentum=1, affine=True),
                        nn.ReLU(),
                        nn.MaxPool2d(2))
        self.layer3 = nn.Sequential(
                        mnn.rConv2d(64,64,kernel_size=3,padding=1, weight_manifold = mnn.Stiefel),
                        nn.BatchNorm2d(64, momentum=1, affine=True),
                        nn.ReLU())
...
class RelationNetwork(nn.Module):
    ...
    def __init__(self,input_size,hidden_size):
        ...
        self.layer1 = nn.Sequential(
                        mnn.rConv2d(128,64,kernel_size=3,padding=1,weight_manifold = mnn.Stiefel),
                        nn.BatchNorm2d(64, momentum=1, affine=True),
                        nn.ReLU(),
                        nn.MaxPool2d(2))
        self.layer2 = nn.Sequential(
                        ...
                        nn.ReLU(),
                        nn.MaxPool2d(2))
        self.fc1 = mnn.rLinear(input_size,hidden_size,weight_manifold = mnn.Stiefel)
        self.fc2 = mnn.rLinear(hidden_size,1,weight_manifold = mnn.Stiefel)
...
def main():
    ...
    feature_encoder_optim = moptim.rAdagrad(feature_encoder.parameters(),lr=LEARNING_RATE)
    
    feature_encoder_scheduler = StepLR(feature_encoder_optim,step_size=100000,gamma=0.5)
    #relation_network_optim = torch.optim.Adam(relation_network.parameters(),lr=LEARNING_RATE)
    relation_network_optim = moptim.rAdagrad(relation_network.parameters(),lr=LEARNING_RATE)
